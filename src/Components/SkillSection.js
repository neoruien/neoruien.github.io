...
import balsamiq from "../img/about/balsamiq.svg";
  ...
  return (
    <div className="SkillSection">
      <Carousel
        ...
        forwardBtnProps={{
          children: (
            <FontAwesomeIcon icon={faAngleRight} className="carousel-button" />
          ),
          style: {
            width: "2.5rem",
            height: "2.5rem",
        ...
        backwardBtnProps={{
          children: (
            <FontAwesomeIcon icon={faAngleLeft} className="carousel-button" />
          ),
          style: {
            width: "2.5rem",
            height: "2.5rem",
      ...
      >
        ...
        <div className="skill-category">
          ...
          <div className="category-cards">
            ...
            <SkillCard image={figma} title="Figma" />
            <SkillCard image={balsamiq} title="Balsamiq" />
          </div>
        </div>
        <div className="skill-category">
