...
const portfolios = [
    ...
    },
    {
        ...
        projectType: 'Personal Project',
        description: "The website utilizes the web camera to detect and label objects in real-time. It was deployed using TensorFlow's Coco SSD model.",
        published: 'May 2021',
    ...
    // },
    {
        ...
        description: 'The website displays an interactive temperature dashboard and floorplan of NUS USP College Residences. The user can select rooms from the floorplan, indicate a time period and view the generated graph.',
        published: 'Apr 2021',
    ...
    },
    {
        ...
        description: "The database application facilitates the operations of a training course company. It stores the schema and functions that manage the courses, instructors and customers of the company.",
        published: 'Apr 2021',
    ...
    },
    {
        ...
        projectType: 'Personal Project',
        description: 'The page fetches JSONPlaceholder typicode user data using Axios and displays the data as a single page website.',
        published: 'Feb 2021',
    ...
    },
    {
        ...
        description: "NOT Schrödinger's Box is an IoT solution for storage organisation problems. The mobile app provides an interface for the user to control the hardware box.",
        published: 'Jan 2021',
    ...
    },
    {
        ...
        description: 'Employee Attrition Analysis presents the possible factors for employee attrition. The dataset was obtained from Kaggle and it was examined via exploratory data analysis.',
        published: 'Dec 2020',
    ...
    },
    {
        ...
        description: 'Serenity helps to relieve the administrative burden of tutors by facilitating attendance taking, participation marking and question addressing procedures.',
        published: 'Nov 2020',
    ...
    },
    {
        ...
        description: 'Pixels Fly is a fun and immersive game where the user is able to fly through the streets of Singapore as a bird. The game was presented on NUS Computing Day 2020.',
        published: 'Aug 2020',
